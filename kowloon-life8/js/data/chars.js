...
export const CHARS = {
  ...
  HOSHIKAGE: {
    ...
    speech: { firstPerson: '私', secondPerson: '君', sentenceEndings: ['ねえ', 'だよ'], politeness: 'cinephile', forbiddenTokens: [] },
    tasteTags: [], growthRate: 1.1,
    homeFacility: 'cinema',
    profile: '映画館「シネマ・ホシカゲ」の館長。無類の映画好きで、語り出すと止まらない。蝶ネクタイがトレードマーク。住民たちに古今東西の名画を薦めるのが生きがい。',
  },
};
