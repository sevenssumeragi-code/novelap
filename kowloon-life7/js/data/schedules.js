...
export const SCHEDULES = {
  LENNY: {
    blocks: [
      ...
      [660, 780, 'SHOP', ['market', 'cafe', 'konbini', 'cake']],
      [780, 960, 'NAP', ['HOME', 'ROOF']],
      [960, 1140, 'LEISURE', ['aquarium', 'ROOF', 'flower', 'book', 'karaoke', 'church']],  // 水族館が大好き
  ...
  HYU: {
    blocks: [
      ...
      [780, 900, 'LEISURE', ['barber', 'flower', 'cake', 'pharmacy']],
      [900, 1140, 'LEISURE', ['cafe', 'cake', 'book', 'church', 'HOME']],
      [1140, 1260, 'BATH', 'sento'],
      [1260, 1380, 'LEISURE', ['karaoke', 'izakaya', 'yakiniku', 'HOME']],
  ...
  JIN: {
    blocks: [
      ...
      [540, 660, 'WANDER', ['market', 'toyshop', 'konbini', 'church']],  // プラモ屋・薬局・コンビニ
  ...
  MUNI: {
    blocks: [
      ...
      [960, 1080, 'LEISURE', ['dagashi', 'toyshop', 'cake', 'church', 'karaoke']],
  ...
  GERU: {
    blocks: [
      ...
      [1080, 1200, 'WANDER', ['GROUND', 'market', 'cake', 'pharmacy', 'church']],  // たまにケーキ(内緒)
  ...
  NEO: {
    blocks: [
      ...
      [900, 1080, 'EXPLORE', ['game', 'book', 'dagashi', 'toyshop', 'church']],
  ...
  CLERK: {
    blocks: [[0, 1440, 'WORK', 'konbini']],   // 24hコンビニに常駐
    exceptions: [],
  },
  MARTIN: {
    blocks: [
