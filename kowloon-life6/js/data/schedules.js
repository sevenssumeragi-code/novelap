...
export const SCHEDULES = {
  LENNY: {
    blocks: [
      ...
      [960, 1140, 'LEISURE', ['aquarium', 'ROOF', 'flower', 'book', 'karaoke']],  // 水族館が大好き
  ...
  HYU: {
    blocks: [
      ...
      [900, 1140, 'LEISURE', ['cafe', 'cake', 'book', 'HOME']],
  ...
  MUNI: {
    blocks: [
      ...
      [960, 1080, 'LEISURE', ['dagashi', 'toyshop', 'cake', 'aquarium', 'karaoke']],
  ...
  GERU: {
    blocks: [
      ...
      [1080, 1200, 'WANDER', ['GROUND', 'market', 'cake', 'pharmacy']],  // たまにケーキ(内緒)
  ...
  NEO: {
    blocks: [
      ...
      [900, 1080, 'EXPLORE', ['game', 'book', 'dagashi', 'toyshop', 'fishshop']],
