...
const ALL = [
  ...
  ...DLG_CAFEGIRL, ...DLG_EXTRA, ...DLG_FURNITURE, ...DLG_V3, ...DLG_V4, ...DLG_V5, ...DLG_V6, ...DLG_V7, ...DLG_V8, ...DLG_V9, ...DLG_V10, ...DLG_V11, ...DLG_V12, ...DLG_V13, ...DLG_V14, ...DLG_V15, ...buildFacilityNodes(), ...DLG_AMBIENT,
];
const errors = [];
const warnings = [];
