...
import { DLG_CAFEGIRL } from '../js/data/dlg_cafegirl.js';
import { DLG_EXTRA } from '../js/data/dlg_extra.js';
import { DLG_FURNITURE } from '../js/data/dlg_furniture.js';
import { DLG_V3 } from '../js/data/dlg_v3.js';
import { DLG_V4 } from '../js/data/dlg_v4.js';
import { DLG_V5 } from '../js/data/dlg_v5.js';
import { DLG_V6 } from '../js/data/dlg_v6.js';
import { DLG_V7 } from '../js/data/dlg_v7.js';
import { DLG_V8 } from '../js/data/dlg_v8.js';
import { DLG_V9 } from '../js/data/dlg_v9.js';
import { DLG_V10 } from '../js/data/dlg_v10.js';
import { DLG_V11 } from '../js/data/dlg_v11.js';
import { DLG_V12 } from '../js/data/dlg_v12.js';
import { DLG_V13 } from '../js/data/dlg_v13.js';
import { DLG_V14 } from '../js/data/dlg_v14.js';
import { DLG_V15 } from '../js/data/dlg_v15.js';
import { DLG_V16 } from '../js/data/dlg_v16.js';
import { DLG_V17 } from '../js/data/dlg_v17.js';
import { buildFacilityNodes } from '../js/data/facility_talk.js';

const ALL = [
  ...DLG_LENNY, ...DLG_HYU, ...DLG_JIN, ...DLG_MUNI, ...DLG_GERU, ...DLG_NEO, ...DLG_NPC,
  ...DLG_CAFEGIRL, ...DLG_EXTRA, ...DLG_FURNITURE, ...DLG_V3, ...DLG_V4, ...DLG_V5, ...DLG_V6, ...DLG_V7, ...DLG_V8, ...DLG_V9, ...DLG_V10, ...DLG_V11, ...DLG_V12, ...DLG_V13, ...DLG_V14, ...DLG_V15, ...DLG_V16, ...DLG_V17, ...buildFacilityNodes(), ...DLG_AMBIENT,
];
const errors = [];
const warnings = [];
