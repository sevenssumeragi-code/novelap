...
export const LETTERS = [
  ...
  L('LTR_HOSHIKAGE', {
    ...
    slots: {
      GREETING: [{ cond: 'true', text: '拝啓、大家さん。名画は手紙のように残る……というわけで、私も一筆したためたよ。' }],
      BODY: [{ cond: 'true', text: 'この街に映画館を建ててくれた恩は、フィルム千巻ぶんだ。暗闇の中で夢を見る場所を、私はずっと守っていくよ。' }],
      CONTEXT: [
        { cond: 'weather == RAIN', text: '今日みたいな雨の日は、来館者が増えてねえ。傘を畳んで暗闇に入る、あの背徳感がたまらないんだろう。' },
        { cond: 'true', text: '床屋の親父さんと郵便屋君は、私の映画仲間だ。今度、君も交えて上映会をやろうじゃないか。' },
      ],
