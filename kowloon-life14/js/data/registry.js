...
export const FLAGS = {
  ...
  FLG_MET_HOSHIKAGE: '映画館館長 星影幸太郎と初対面',
...
export const DICTIONARY = {
  ...
  HOSHIKAGE: [
    { cond: 'true', text: '映画館「シネマ・ホシカゲ」の老館長。蝶ネクタイがトレードマークの映画狂。話し方は「〜のう」「〜じゃ」の好々爺。', source: 'プロフィール' },
    { cond: 'flag(FLG_MET_HOSHIKAGE)', text: '古今東西の名画を住民に薦めるのが生きがい。床屋のオヤジや郵便屋とも映画談義を交わす仲。', source: '映画館での出会い' },
  ],
};
