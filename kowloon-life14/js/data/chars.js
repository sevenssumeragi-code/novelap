...
export const KEY_IDS = ['BARBER', 'KANE', 'POSTMAN', 'CAFEGIRL', 'DAGASHIYA', 'THIEF', 'CLERK', 'MARTIN', 'HOSHIKAGE'];
...
export const CHARS = {
  ...
  MARTIN: {
    id: 'MARTIN', name: 'マルタン神父', kind: 'key', priest: true,
    hair: 0x1a1a20, eye: 0x3a4a5a, cloth: 0xf0efe8, pants: 0xe4e2d8,
    hairStyle: 'priest', scale: 1.05,
    speech: { firstPerson: 'わたし', secondPerson: 'あなた', sentenceEndings: ['ですな', 'ですぞ'], politeness: 'gentle-elder', forbiddenTokens: [] },
    tasteTags: [], growthRate: 1.1,
    homeFacility: 'church',
    profile: '九龍聖堂のマルタン神父。真面目でいい人。黒髪に白い祭服。懺悔室で主要人物6人の悩みや後悔に、静かに耳を傾けている。',
  },
  HOSHIKAGE: {
    id: 'HOSHIKAGE', name: '星影幸太郎', kind: 'key', director: true,
    hair: 0x2a2a2a, eye: 0x4a3a2a, cloth: 0x3a2f4a, pants: 0x22202a,
    hairStyle: 'slick', scale: 1.04,
    speech: { firstPerson: 'わし', secondPerson: 'おぬし', sentenceEndings: ['のう', 'じゃ'], politeness: 'cinephile-elder', forbiddenTokens: [] },
    tasteTags: [], growthRate: 1.1,
    homeFacility: 'cinema',
    profile: '映画館「シネマ・ホシカゲ」の老館長。無類の映画好きで、語り出すと止まらない。蝶ネクタイがトレードマーク。話し方は「〜のう」「〜じゃ」の好々爺。住民たちに古今東西の名画を薦めるのが生きがい。',
  },
};
...
export const PAIRS = [
  ...
  { a: 'CLERK', b: 'HYU', init: 30, growth: 1.0 },      // ヒュウの口説き相手その2
  { a: 'CAFEGIRL', b: 'CLERK', init: 45, growth: 1.0 }, // 看板娘どうし仲良し
  // マルタン神父(懺悔室で6人の悩みを聞く)
  { a: 'MARTIN', b: 'LENNY', init: 40, growth: 1.0 },
  { a: 'MARTIN', b: 'HYU', init: 40, growth: 1.0 },
  { a: 'MARTIN', b: 'JIN', init: 40, growth: 1.0 },
  { a: 'MARTIN', b: 'GERU', init: 42, growth: 1.0 },
  { a: 'MARTIN', b: 'MUNI', init: 44, growth: 1.0 },
  { a: 'MARTIN', b: 'NEO', init: 40, growth: 1.0 },
  { a: 'MARTIN', b: 'KANE', init: 48, growth: 1.0 },
  // 星影幸太郎(映画館の館長) — 主要6人 + 床屋 + 郵便屋と話す
  { a: 'HOSHIKAGE', b: 'LENNY', init: 40, growth: 1.0 },
  { a: 'HOSHIKAGE', b: 'HYU', init: 42, growth: 1.0 },
  { a: 'HOSHIKAGE', b: 'JIN', init: 40, growth: 1.0 },
  { a: 'HOSHIKAGE', b: 'GERU', init: 44, growth: 1.0 },
  { a: 'HOSHIKAGE', b: 'MUNI', init: 40, growth: 1.0 },
  { a: 'HOSHIKAGE', b: 'NEO', init: 42, growth: 1.0 },
  { a: 'HOSHIKAGE', b: 'BARBER', init: 46, growth: 1.0 },
  { a: 'HOSHIKAGE', b: 'POSTMAN', init: 46, growth: 1.0 },
];
