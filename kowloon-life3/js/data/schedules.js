...
export const SCHEDULES = {
  LENNY: {
    blocks: [
      ...
      [960, 1140, 'LEISURE', ['ROOF', 'flower', 'book', 'karaoke']],
  ...
  HYU: {
    blocks: [
      ...
      [600, 660, 'LEISURE', 'cafe'],
      [660, 780, 'SHOP', ['market', 'cafe', 'konbini']],
      [780, 900, 'LEISURE', ['barber', 'flower', 'cafe', 'pharmacy']],
  ...
  JIN: {
    blocks: [
      ...
      [540, 660, 'WANDER', ['market', 'toyshop', 'konbini', 'pharmacy']],  // プラモ屋・薬局・コンビニ
      [660, 780, 'MEAL', ['ramen', 'market']],
      [780, 1080, 'WORK', ['market', 'GROUND']],
      [1080, 1140, 'LEISURE', 'toyshop'],              // プラモデルの新作チェック
      [1140, 1260, 'BATH', 'sento'],                  // 夜は銭湯(男湯グループ)
      [1260, 1320, 'LEISURE', ['izakaya', 'karaoke', 'GROUND']],  // 湯上がりに一杯 or カラオケ
  ...
  MUNI: {
    blocks: [
      [0, 420, 'SLEEP', 'HOME'],
      [420, 600, 'HOME', 'HOME'],
      [600, 660, 'LEISURE', ['dagashi', 'toyshop']],   // 玩具屋でおねだり
      [660, 780, 'SHOP', ['market', 'dagashi', 'konbini']],
      [780, 960, 'FOLLOW_LENNY', 'FOLLOW'],
      [960, 1080, 'LEISURE', ['dagashi', 'toyshop', 'game', 'karaoke']],
  ...
  GERU: {
    blocks: [
      ...
      [1080, 1200, 'WANDER', ['GROUND', 'market', 'flower', 'pharmacy']],  // 夜更かし用の目薬
  ...
  NEO: {
    blocks: [
      [0, 420, 'SLEEP', 'HOME'],
      [420, 600, 'HOME', 'HOME'],
      [600, 660, 'EXPLORE', ['barber', 'pharmacy', 'konbini', 'GROUND']],
      [660, 780, 'SHOP', ['market', 'ramen']],
      [780, 900, 'MEAL', ['ramen', 'cafe']],
      [900, 1080, 'EXPLORE', ['game', 'book', 'dagashi', 'toyshop']],  // 玩具屋の剣の玩具を凝視
  ...
  THIEF: {
    blocks: [
      [0, 600, 'LURK', 'konbini'],         // コソ泥は24hコンビニに潜む
      [600, 1020, 'LURK', ['konbini', 'GROUND']],
      [1020, 1320, 'LURK', 'konbini'],
      [1320, 1440, 'LURK', ['konbini', 'GROUND']],
    ],
    exceptions: [],
  },
};
